...
import { sendCollectSonglist } from '@/services/songs'

export default memo(function SongDetailLeft(props) {
  // props/state

  // redux
  const dispatch = useDispatch()
  const { songDetail,playlist, isLogin, cookie } = useSelector(
    (state) => ({
      songDetail:state.getIn(['songListDetail','songListInfo']),
      playlist: state.getIn(['songListDetail', 'songListPlayList']),
